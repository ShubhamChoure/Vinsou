  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#FAF8F5] font-sans pt-2 sm:pt-4 pb-8 lg:pb-12 min-h-0 lg:min-h-[calc(100vh-70px)] flex items-start lg:items-center">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 flex items-center justify-center overflow-hidden">
        <LeafSVG className="w-[300px] sm:w-[450px] lg:w-[540px] h-[380px] sm:h-[550px] lg:h-[620px] text-black" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 lg:gap-12">
          ...
          {/* TEXT CONTENT */}
          <div className="flex flex-col items-start w-full lg:max-w-[580px] z-20 pt-1 lg:pt-0">
            ...
            <h1 className="text-[34px] sm:text-[48px] md:text-[56px] lg:text-[70px] font-extrabold text-[#0D0D0D] leading-[1.12] tracking-tight mb-4 sm:mb-6">
              ...
              <span className="inline-flex flex-wrap items-center gap-2 sm:gap-3 mt-1">
                <span>For</span>
                <span className="bg-[#FFCC00] px-3 sm:px-4 py-0.5 sm:py-1 inline-flex items-center justify-center rounded-[2px] transition-all duration-300 shadow-xs">
                  <span
            ...
            <div className="flex gap-3 mb-5 sm:mb-7">
              <button aria-label="Instagram" className="w-[44px] h-[44px] sm:w-[48px] sm:h-[48px] bg-[#FFCC00] rounded-[4px] flex items-center justify-center hover:scale-105 active:scale-95 transition-transform">
                <InstagramIcon />
              </button>
              <button aria-label="Message" className="w-[44px] h-[44px] sm:w-[48px] sm:h-[48px] bg-[#FFCC00] rounded-[4px] flex items-center justify-center hover:scale-105 active:scale-95 transition-transform">
